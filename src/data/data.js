export const siteData = {
	...
	projects: [
		...
		{
			id: 2,
			title: "AlgoRank – Competitive Coding Analyzer",
			description:
				"A tool to analyze coding submissions, rank performance, and highlight algorithmic strengths. Built with MERN and visualization libraries.",
